...
path('',views.User_Login.as_view(),name='user_login'),
    ...
    path('delete_user_group/<str:id>/',views.Delete_User_Group.as_view(), name='delete_user_group'),
    path('update_user_group/',views.Update_User_Group.as_view(), name='update_user_group'),
