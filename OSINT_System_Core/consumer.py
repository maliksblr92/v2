...
from OSINT_System_Core.rabbit_message_responder import on_messege_recived
class Rabbit_Consumer(object):
    ...
    def connect(self):
        ...
        return pika.SelectConnection(
            parameters=pika.ConnectionParameters(host=self.HOSTNAME, credentials=self.CREDENTIALS,virtual_host=self.VIRTUAL_HOST),
